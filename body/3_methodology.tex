...
\begin{enumerate}
	...
	\begin{itemize}
		\item The temperature at the centre of the block will be taken as this sensor data is what will be used ass feedback for the controller to be implemented. This follows the recommendations given in Section \ref{cha:literaturereview} by Vilchiz et. al.
	...
	\item The response of the system to the step input will then be logged and the temperature response of the block center will be used to identify the modules plant function via MATLAB.
